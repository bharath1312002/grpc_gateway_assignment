...
const (
	...
	UserService_UpdateUserContact_FullMethodName = "/user.UserService/UpdateUserContact"
...
type UserServiceClient interface {
	...
	UpdateUserContact(ctx context.Context, in *UpdateUserContactRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) UpdateUserContact(ctx context.Context, in *UpdateUserContactRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, UserService_UpdateUserContact_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	UpdateUserContact(context.Context, *UpdateUserContactRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) UpdateUserContact(context.Context, *UpdateUserContactRequest) (*UserResponse, error) {
...
func _UserService_UpdateUserContact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateUserContact_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateUserContact(ctx, req.(*UpdateUserContactRequest))
	}
	return interceptor(ctx, in, info, handler)
}
